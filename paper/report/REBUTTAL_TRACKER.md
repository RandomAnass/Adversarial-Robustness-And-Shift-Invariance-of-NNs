...
| C7 | Does not confront TIPS/Wang-2025 | experiment | ✅ **DONE** — TIPS ported as held-out arm (5 AT cells, 3+2 seeds): law fitted WITHOUT it predicts its AA to ±0.012 (§5). Weak-vs-strong table: FGSM reproduces invariance-helps, AutoAttack ≤0.008 all arms. A1: aux losses restore FGSM gain, AA still 0.004. B1: Wang-2025's OWN P4 model retrained with their code — FGSM reproduces (28.5%), threat-matched AA 0.10%. Consistency uninformative both directions. |
| C8 | CIFAR-scale only | experiment | ✅ **DONE** — ImageNet-100 (126,689 imgs, 4 capacity-matched arms, Fast-AT ε=4/255, 2 seeds): both laws hold (matched η/L1 +0.90, consist −0.87) AND clean accuracy FLAT across arms (0.641–0.649, +0.08) so the dissociation is confound-free at scale. §5. |
...
**STATUS 2026-07-04:** All 10 criticisms addressed. All strengthen experiments (S1a/S2/S3/B1/A1/A5) complete + integrated. Author theory (certificate count/scale-family/tail/certifiable-α) verified + integrated. Paper 33pp. In review rounds: numbers-audit (ResNet block done, 3 fixes commit 3b357e6; remaining blocks re-launching) → figure-audit → coherence → first-time-reader → panel(2+1+meta).
